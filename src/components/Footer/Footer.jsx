            ...
            <div className="footer-main-content">
                <div className="footer-col footer-col-exclusive">
                    ...
                    <div className="subscribe-input">
                        <input type="email" placeholder="Enter your email" className="subscribe-email-input" />
                ...
                <div className="footer-col">
                    ...
                    <div className="footer-links-group">
                        <p className="footer-text">Ly Thuong Kiet Street, District 10, Ho Chi Minh City, Vietnam</p>
                        <a href="mailto:sinhle@gmail.com" className="footer-link">sinhle@gmail.com</a>
                        <a href="tel:+84039888889999" className="footer-link">+84-039-88888-9999</a>
                    </div>
                </div>
                ...
                <div className="footer-col footer-col-download">
                    ...
                    <div className="app-download-section">
                        ...
                        <div className="app-store-links">
                            <a href="#"><img src={googlePlay} alt="Google Play" className="app-icon google-play-icon" /></a>
                            <a href="#"><img src={appStore} alt="App Store" className="app-icon app-store-icon" /></a>
                        </div>
                    </div>
                    
                    <div className="social-icons">
                        <a href="#"><img src={iconFacebook} alt="Facebook" className="social-icon" /></a>
                        <a href="#"><img src={iconTwitter} alt="Twitter" className="social-icon" /></a>
                        <a href="#"><img src={iconInstagram} alt="Instagram" className="social-icon" /></a>
                        <a href="#"><img src={iconLinkedIn} alt="LinkedIn" className="social-icon" /></a>
                    </div>
                </div>
            </div>

            <div className="footer-bottom">
                <p className="copyright-text">Copyright 2025 Dr. Orion Knight, All Rights Reserved.</p>
            </div>
        </footer>
    );
};
